...
- Show replies when a post is opened via direct link. And add a button in the interactions row to view quotes (applicable to both single view and list item view).
...
Demo website: [https://quip-web-app.web.app](https://quip-web-app.web.app)
